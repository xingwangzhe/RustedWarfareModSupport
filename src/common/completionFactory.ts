 ...
 * @returns 补全提供者实例数组
 */
export function createCompletionProviders(configs: CompletionProviderConfig[]): vscode.CompletionItemProvider[] {
...
export const completionProviderConfigs: CompletionProviderConfig[] = [
    ...
    { sectionName: 'global_resource', matcher: (name: string) => isBaseSection(name, 'global_resource') },
