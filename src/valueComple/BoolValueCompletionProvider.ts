...
import { createCompletionItemsFromDataFile, getFallbackBoolItems } from '../common/valueCompletionUtils';
...
export class BoolValueCompletionProvider extends BaseValueCompletionProvider {
    ...
    private getBoolCompletionItems(): vscode.CompletionItem[] {
        const items = createCompletionItemsFromDataFile('bool', vscode.CompletionItemKind.Value, 'valuecompletionprovider.bool.detail');
