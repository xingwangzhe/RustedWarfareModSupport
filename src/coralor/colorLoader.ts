...
export class ColorLoader {
  ...
  public getColor(typeName: string): string {
    ...
    const rules: Array<{ re: RegExp; darkColor: string; lightColor: string }> =
      [
        {
          re: /string|locale|name|text|message|leg\/arm/,
          darkColor: "#FF6B6B",
          lightColor: "#DC2626",
        },
        {
          re: /int|float|number|degrees|static integer|logicnumber/,
          darkColor: "#4ECDC4",
          lightColor: "#0D9488",
        },
        {
          re: /bool|true|false|logic|logicboolean/,
          darkColor: "#3B82F6",
          lightColor: "#2563EB",
        },
        {
          re: /ref|id|ids|refs|action ids|marker ref|animation id/,
          darkColor: "#A855F7",
          lightColor: "#7C3AED",
        },
        { re: /price|cost|money/, darkColor: "#FBBF24", lightColor: "#D97706" },
        {
          re: /effect|effects|decal|projectile|animation/,
          darkColor: "#EC4899",
          lightColor: "#BE185D",
        },
        { re: /sound|audio/, darkColor: "#3B82F6", lightColor: "#2563EB" },
        {
          re: /resource|resources|customResource|dynamic resources|dynamic/,
          darkColor: "#06B6D4",
          lightColor: "#0891B2",
        },
        { re: /time|seconds/, darkColor: "#FF8A65", lightColor: "#C2410C" },
        {
          re: /point|point3d|marker|marker ref/,
          darkColor: "#F59E0B",
          lightColor: "#D97706",
        },
        { re: /tag|tags|tag ref/, darkColor: "#94A3B8", lightColor: "#64748B" },
        { re: /image|file/, darkColor: "#3B82F6", lightColor: "#2563EB" },
        ...
        {
          re: /enum|memory|draw|style|relation/,
          darkColor: "#64748B",
          lightColor: "#475569",
        },
        {
          re: /attachment|leg|arm|frame/,
          darkColor: "#F472B6",
          lightColor: "#DB2777",
        },
        {
          re: /list|array|collection|items/,
          darkColor: "#FBBF24",
          lightColor: "#D97706",
        },
      ];
